        ...
        switch (v.getId()) {
            case R.id.btn_yes:
                ...
                if (optionGood.isChecked()) {
                    optionProductivity = 2;
                } else if (optionMedium.isChecked()) {
                    optionProductivity = 1;
                } else if (optionBad.isChecked()) {
                    optionProductivity = 0;
                }
                ...
                if (optionHappyBefore.isChecked()) {
                    optionHumorBefore = 2;
                } else if (optionNeutralBefore.isChecked()) {
                    optionHumorBefore = 1;
                } else if (optionSadBefore.isChecked()) {
                    optionHumorBefore = 0;
                }
                /* END RADIO BUTTONS */
